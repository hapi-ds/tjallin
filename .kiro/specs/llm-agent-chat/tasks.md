...
- [ ] 1. Set up project structure and core modules
  - [ ] 1.1 Create `src/tj_chat` package with settings and data models
  ...
  - [ ] 1.2 Implement path safety module
...
- [ ] 2. Implement project reader and generators
  ...
  - [ ] 2.2 Write property test for task similarity search
  ...
  - [ ] 2.3 Implement timesheet generator
  ...
  - [ ] 2.4 Write property tests for timesheet generation
  ...
  - [ ] 2.5 Implement journal entry generator
  ...
  - [ ] 2.10 Write property test for task generation
    - **Property 18: Task generation includes required attributes**
    - **Validates: Requirements 3.2**
    - Create `tests/property/test_tj_chat_task_gen_property.py`

- [ ] 3. Implement TJ Documentation Service
  - [ ] 3.1 Prepare TaskJuggler reference documentation
  ...
  - [ ] 3.2 Implement TJDocumentationService class
  ...
  - [ ] 3.3 Write property test for TJ docs search
...
- [ ] 5. Implement conversation manager
  - [ ] 5.1 Implement conversation manager
  ...
  - [ ] 5.2 Write property tests for conversation manager
  ...
  - [ ] 5.3 Implement system prompt builder
  ...
  - [ ] 5.4 Write property test for system prompt content
...
- [ ] 6. Implement tool executor and safety layer
  - [ ] 6.1 Implement tool executor
  ...
  - [ ] 6.2 Write property tests for backup and compiler safety
  ...
  - [ ] 6.3 Write property test for write confirmation summary
...
- [ ] 7. Implement chat service
  - [ ] 7.1 Implement chat service core
  ...
  - [ ] 7.2 Implement overdue detection and proactive guidance
  ...
  - [ ] 7.3 Write property test for overdue detection
...
- [ ] 9. Implement NiceGUI web application pages
  - [ ] 9.1 Create NiceGUI app entry point and navigation
  ...
  - [ ] 9.6 Implement slash commands and input validation
  ...
  - [ ] 9.7 Write property tests for input validation
  ...
  - [ ] 9.8 Implement graceful degradation
...
- [ ] 11. Docker integration and service replacement
  - [ ] 11.1 Update tj-web Dockerfile for Python/NiceGUI
  ...
  - [ ] 11.2 Update docker-compose.yml for new tj-web service
  ...
  - [ ] 11.3 Update `.env.example` with new chat-related variables
...
- [ ] 12. Documentation updates
  ...
  - [ ] 12.2 Update docs/user-guide.md
