...
- [x] 1. Set up project structure and shared utilities
  ...
  - [x] 1.2 Implement shared Python utility modules
  ...
  - [x] 1.3 Create comprehensive sample project — main file and accounts
  ...
  - [x] 1.4 Create sample project — resource definitions
  ...
  - [x] 1.5 Create sample project — task hierarchy with dependencies and milestones
  ...
  - [x] 1.6 Create sample project — report definitions
  ...
  - [x] 1.7 Create sample project — timesheet files
  ...
  - [x] 1.8 Create sample project documentation
  ...
  - [x] 1.9 Write property tests for environment validation (Property 1)
  ...
  - [x] 1.10 Write property tests for email attachment validation (Property 2)
  ...
  - [x] 1.11 Write property tests for oversized email rejection (Property 3)
  ...
  - [x] 1.12 Write property tests for log formatting (Property 4)
  ...
  - [x] 1.13 Write property tests for task failure logging (Property 5)
  ...
  - [x] 1.14 Write property tests for overlapping task prevention (Property 6)
  ...
  - [x] 1.15 Write property tests for invalid log level fallback (Property 7)
...
- [x] 3. Implement TJ Core Service
  - [x] 3.1 Create TJ Core Dockerfile and entrypoint
  ...
  - [x] 3.2 Create compilation script
  ...
  - [x] 3.3 Write unit tests for compilation script logic
...
- [x] 4. Implement TJ Web Service
  - [x] 4.1 Create TJ Web Dockerfile and entrypoint
  ...
  - [x] 4.2 Create fallback status page
  ...
  - [x] 4.3 Write unit tests for web service entrypoint logic
    - Test process restart behavior
    - Test fallback page serving condition
    - _Requirements: 4.5, 4.7_

- [x] 5. Implement Mail Service
  - [x] 5.1 Create Mail Service Dockerfile and configuration
  ...
  - [x] 5.2 Create inbound email processing pipeline
  ...
  - [x] 5.3 Create timesheet collection and reminder scripts
  ...
  - [x] 5.4 Write unit tests for email processing pipeline
...
- [x] 6. Implement Cron Service
  - [x] 6.1 Create Cron Service Dockerfile and entrypoint
  ...
  - [x] 6.2 Create task execution wrapper script
  ...
  - [x] 6.3 Write unit tests for task execution wrapper
...
- [x] 8. Create Docker Compose file and wire services together
  - [x] 8.1 Create docker-compose.yml
  ...
  - [x] 8.2 Create startup validation and initialization
...
- [x] 9. Implement manual trigger scripts
  - [x] 9.1 Create scripts/rebuild.sh
  ...
  - [x] 9.2 Create scripts/collect-timesheets.sh
  ...
  - [x] 9.3 Create scripts/send-reminders.sh
  ...
  - [x] 9.4 Write integration tests for manual trigger scripts
...
- [x] 11. Write user guide and rewrite README
  - [x] 11.1 Create docs/user-guide.md
...
- [x] 12. Integration testing and final validation
  - [x] 12.1 Write integration tests for stack startup and volume sharing
  ...
  - [x] 12.2 Write integration tests for email and cron workflows
  ...
  - [x] 12.3 Write integration tests for sample project compilation
  ...
  - [x] 12.4 Write end-to-end test for full workflow
